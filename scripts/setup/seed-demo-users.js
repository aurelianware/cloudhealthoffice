...
const usersData = [
  ...
  },
  {
    ...
    firstName: "Emily",
    lastName: "Rodriguez",
    email: "emily.rodriguez@demo.local",
    role: "ClaimsExaminer",
    department: "Claims",
    supervisorId: sarahId,
    recentLogin: true
  ...
  // Member Services
  {
    ...
    firstName: "Jennifer",
    lastName: "Williams",
    email: "jennifer.williams@demo.local",
    role: "MemberServices",
  ...
  },
  {
    ...
    firstName: "Robert",
    lastName: "Garcia",
    email: "robert.garcia@demo.local",
    role: "MemberServices",
    department: "Member Services",
    supervisorId: null,
    recentLogin: true
  ...
  // Utilization Management
  {
    ...
    firstName: "Lisa",
    lastName: "Martinez",
    email: "lisa.martinez@demo.local",
    role: "UMCoordinator",
    department: "UM",
    supervisorId: null,
    recentLogin: true
  },
  {
    ...
    firstName: "David",
    lastName: "Thompson",
    email: "david.thompson@demo.local",
    role: "UMCoordinator",
    department: "UM",
    supervisorId: null,
    recentLogin: true
  ...
  // Provider Relations
  {
    ...
    firstName: "Amanda",
    lastName: "Foster",
    email: "amanda.foster@demo.local",
  ...
  // Finance
  {
    ...
    firstName: "James",
    lastName: "Anderson",
    email: "james.anderson@demo.local",
    role: "Finance",
    department: "Finance",
    supervisorId: null,
    recentLogin: false
