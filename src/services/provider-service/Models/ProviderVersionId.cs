...
/// 48-bit timestamp + 80-bit randomness) for provider versions.
///
/// Mirrors <c>BenefitPlanService.Models.PlanVersionId</c> — we inline a
/// minimal generator rather than take a dependency: the only requirements
/// are lexicographic monotonicity by creation time and global uniqueness,
/// which a millisecond-prefixed ULID satisfies.
/// </summary>
internal static class ProviderVersionId
{
