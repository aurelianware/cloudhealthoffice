...
public class GatewayVendorNeutralityTests
{
    ...
    public void CanonicalEligibilityModels_ExposeOnlyNeutralPropertyTypes()
    {
        ...
        var models = new[]
        {
            ...
            typeof(GatewayClaimAcknowledgment),
            typeof(GatewayClaimAcknowledgmentClaimResult),
            ...
            typeof(ClaimStatusRequest),
            typeof(ClaimStatusResponse),
            ...
            typeof(RemittancePostRequest),
            typeof(RemittancePostResult),
            typeof(RemittanceClaimPost),
            typeof(RemittanceAccumulatorApply),
