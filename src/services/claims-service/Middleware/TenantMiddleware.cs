namespace ClaimsService.Middleware;

/// <summary>
/// Middleware to extract TenantId from JWT claims or headers
/// Multi-tenant SaaS isolation: each tenant's claims are partitioned by TenantId
/// </summary>
public class TenantMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        _logger.LogInformation("Request authenticated for TenantId: {TenantId}", SanitizeForLog(tenantId));
