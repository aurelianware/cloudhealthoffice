...
public class TenantMiddlewareTests
{
    ...
    [Fact]
    public async Task InvokeAsync_WithoutXTenantIdHeader_Returns400BadRequest()
    {
        // Arrange
        var context = new DefaultHttpContext();
    ...
    [Fact]
    public async Task InvokeAsync_WithEmptyXTenantIdHeader_Returns400BadRequest()
    {
        // Arrange
        var context = new DefaultHttpContext();
    ...
    [Fact]
    public async Task InvokeAsync_WithWhitespaceXTenantIdHeader_Returns400BadRequest()
    {
        // Arrange
        var context = new DefaultHttpContext();
