...
4. **Analytics Injection**: `src/site/build.mjs` injects the Google Analytics tag for measurement ID `G-H1HCD5EYPN` into built HTML artifacts (run as `node build.mjs` from within `src/site`)
