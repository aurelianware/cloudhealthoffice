...
/// <summary>
/// Verifies that accumulator-service registers <see cref="JsonStringEnumConverter"/>
...
/// </summary>
public class SharedJsonOptionsSmokeTests : IClassFixture<AccumulatorsControllerTests.Factory>
{
    private readonly AccumulatorsControllerTests.Factory _factory;

    public SharedJsonOptionsSmokeTests(AccumulatorsControllerTests.Factory factory) => _factory = factory;
