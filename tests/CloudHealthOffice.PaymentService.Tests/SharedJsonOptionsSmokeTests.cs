...
/// <summary>
/// Verifies that payment-service registers <see cref="JsonStringEnumConverter"/>
...
/// </summary>
public class SharedJsonOptionsSmokeTests : IClassFixture<PaymentApiFactory>
{
    private readonly PaymentApiFactory _factory;

    public SharedJsonOptionsSmokeTests(PaymentApiFactory factory) => _factory = factory;
