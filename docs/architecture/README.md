...
- [SMART on FHIR / OAuth trust](smart-oauth-trust.md) — external issuer trust,
  OIDC discovery, JWKS rotation, caller identity, tenant binding, fail-closed startup.
- [Identity provider integration contract](idp-integration-contract.md) — what a
  payer's IdP must provide, and how each value is used.
...
| Claim intelligence | [claim-intelligence.md](claim-intelligence.md) |
