...
[![Tests](https://img.shields.io/badge/tests-5124%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5124     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,124 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
