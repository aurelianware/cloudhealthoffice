...
[![Tests](https://img.shields.io/badge/tests-5107%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5107     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,107 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
