...
containers, pinned by image digest. Today it proves a PAS `$submit` exchange and
a CRD CDS Hooks exchange against the HL7 burden-reduction payer.
...
./scripts/interop/run.sh br-payer all     # both
```
