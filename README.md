...
[![Tests](https://img.shields.io/badge/tests-5187%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5187     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,187 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
