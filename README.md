...
[![Tests](https://img.shields.io/badge/tests-5151%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5151     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,151 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
