...
[![Tests](https://img.shields.io/badge/tests-5154%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5154     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,154 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
