...
[![Tests](https://img.shields.io/badge/tests-5053%20passing-brightgreen)](./tests/) <!-- auto-updated by test-metrics workflow -->
...
|Automated Tests      |5053     |C# xUnit, TypeScript Jest, Python pytest                                                                    |
...
~5,053 automated tests across 44 test projects in C# (xUnit), TypeScript (Jest), and Python (pytest).
